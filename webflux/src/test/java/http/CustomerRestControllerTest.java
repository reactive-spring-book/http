...
public class CustomerRestControllerTest {
	...
	private AtomicReference<Customer> saved = new AtomicReference<>();

	@Before
	public void before() throws Exception {

		Flux<Customer> iterable = Flux.fromIterable(results);
		...
		Mockito //
				...
				.then(invocation -> {
					...
					Assert.assertTrue(cast instanceof Publisher);
					...
					return Mono.just(new Customer(UUID.randomUUID().toString(),
							saved.get().getName()));
				});
	}
	...
	public void create() throws Exception {
		this.client.post().uri("/rc/customers") //
				.contentType(MediaType.APPLICATION_JSON_UTF8)
