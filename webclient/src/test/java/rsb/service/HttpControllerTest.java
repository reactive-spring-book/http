...
@SpringBootTest(classes = { AuthenticatedConfiguration.class, DefaultConfiguration.class,
		...
		HttpServiceApplication.class }, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT, properties = {
				"spring.profiles.active=client", "server.port=8080",
...
public class HttpControllerTest {
	...
	public void greetAuthenticated() {
		...
		StepVerifier.create(authenticatedGreeting)
				.expectNextMatches(g -> g.getMessage().contains("Hello jlong"))
				.verifyComplete();
	}
